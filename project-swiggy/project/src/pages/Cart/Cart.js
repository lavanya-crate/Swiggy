...
// export const Cart = ({items, setItems ,increment,decrement}) => {
...
//                              <CartCard items={items} setItems={setItems}  decrement={decrement} increment={increment} />
...
//                             </div>
//                             {items.map((item)=>(
//                             <div key={item.menuItemID} className="text-start mt-5">
//                                 <p className="text-sm font-semibold">Bill Details</p>
//                                 <div className="flex text-sm">
//                                     <p>
//                                         Item Total
//                                     </p>
//                                     <span className="pl-40"><i className="fi fi-sr-indian-rupee-sign text-xs pl-10"></i>{item.total_price}</span>
//                                 </div>
...
//                                         TO PAY
//                                     </p>
//                                     <span className="pl-48"><i className="fi fi-sr-indian-rupee-sign text-xs pl-10"></i>{item.total_price}</span>
//                                 </div>
//                             </div>
//                             ))}
//                         </div>
...
const platformFee = 5;
const gstAndRestaurantCharges = 13.95;

const itemTotal = items.reduce((acc, item) => acc + item.total_price, 0);
const totalToPay = itemTotal + deliveryFee + platformFee + gstAndRestaurantCharges;
                        ...
                        <div className=" mx-auto p-6 bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div key={item.menuItemID} className="text-start mt-5">
                                ...
                                <div className="flex text-sm">
                                    ...
                                    <span className="pl-40"><i className="fi fi-sr-indian-rupee-sign text-xs pl-10"></i>{itemTotal.toFixed(2)}</span>
                                </div>
                                <div className="flex text-sm mt-2 mb-3">
                                    <p>
                                        Delivery Fee | 10.0 kms
                                    </p>
                                    <span className="pl-20"><i className="fi fi-sr-indian-rupee-sign text-xs pl-10"></i>{deliveryFee}</span>
                                </div>
                                <hr />
                                <div className="flex text-sm mt-2 mb-3">
                                    <p>
                                ...
                                <div className="flex text-sm mt-2 mb-3">
                                    ...
                                    <span className="pl-40"><i className="fi fi-sr-indian-rupee-sign text-xs pl-10"></i>{platformFee}</span>
                                </div>
                                <div className="flex text-sm mt-2 mb-3">
                                    <p>
                                        GST and Restaurant Charges
                                    </p>
                                    <span className="pl-10"><i className="fi fi-sr-indian-rupee-sign text-xs pl-10"></i>{gstAndRestaurantCharges}</span>
                                </div>
                                <hr className="bg-gray-800 h-0.5" />
                                <div className="flex text-sm font-bold mt-2">
                                    <p>
                                    ...
                                    <span className="pl-40"><i className="fi fi-sr-indian-rupee-sign text-xs pl-10"></i>{totalToPay.toFixed(2)}</span>
                                </div>
                            </div>
                            ))}
                        </div>
